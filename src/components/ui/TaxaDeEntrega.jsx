...
export default function () {
  ...
  return (
    <div onClick={hClick} className="bg-white w-full gap-2.5 p-2.5  flex flex-row align-middle cursor-pointer">
      <svg
      ...
      <p className="font-semibold text-xl text-gray-700">{addressData.logradouro} {addressData.numero}</p>
    </div>
  );
}
